...
import { UserPlus, Fingerprint, Users, FileText } from 'lucide-react'; // إضافة FileText
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <Link to="/edit-user">
            ...
            >
              ...
              <div className="text-right">
                <h3 className="text-lg font-semibold text-blue-600">إدارة الموظفين</h3>
                <p className="text-sm text-gray-600">تعديل أو حذف بيانات الموظفين</p>
              </div>
            </motion.div>
          </Link>
          <Link to="/salary-report">
            ...
            >
              ...
              <div className="text-right">
                <h3 className="text-lg font-semibold text-blue-600">تقرير الراتب</h3>
                <p className="text-sm text-gray-600">عرض تقارير الرواتب للموظفين</p>
              </div>
            </motion.div>
          </Link>
        </div>
